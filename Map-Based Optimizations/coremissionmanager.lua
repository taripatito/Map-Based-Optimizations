...
if level == 'big' then
	function MissionManager:_add_script(data)
		...
		table.insert(data.elements, {
			...
			id = 100046,
			editor_name = 'disable_escapes',
			values = {
				execute_on_startup = false,
				rotation = Rotation(0, 0, -0),
				position = Vector3(2140, 294.322, 6080),
				unit_ids = {
					100205,
					100206,
					100691,
		...
		table.insert(data.elements, {
			...
			id = 100047,
			editor_name = 'enable_escapes',
			values = {
				execute_on_startup = false,
				rotation = Rotation(0, 0, -0),
				position = Vector3(2220, 294.322, 6080),
				unit_ids = {
					100205,
					100206,
					100691,
		...
		--[[
			...
			100046 = Disable Escapes
			100047 = Enable Escapes
			100048 = Disable Vault
			100049 = Enable Vault
		--]]
		...
		for _, element in pairs(data.elements) do
			...
			elseif element.id == 100018 and element.editor_name == 'delayer_v1' or element.id == 106137 and element.editor_name == 'delayer_v2' or element.id == 106151 and element.editor_name == 'delayer_v3' then
				table.insert(element.values.on_executed, {
					delay = 0,
					id = 100046
				})
			...
			elseif element.id == 100836 and element.editor_name == 'drive_in' then
				table.insert(element.values.on_executed, {
					delay = 0,
					id = 100047
				})
			elseif element.id == 105969 and element.editor_name == 'vault_opened' or element.id == 104447 and element.editor_name == 'done' then
				table.insert(element.values.on_executed, {
					delay = 0,
					id = 100049
				})
